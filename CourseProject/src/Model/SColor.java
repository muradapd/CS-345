...
public class SColor extends JComponent
{
	 ...
	 * Copy constructor.
	 * 
	 * @param copyColor is the color to copy.
	 */
	public SColor(SColor copyColor)
	{
		this.name = new String(copyColor.getName());
		this.hue = copyColor.getHue();
		this.value = copyColor.getValue();
		this.chroma = copyColor.getChroma();
	...
	public boolean equals(Object other)
	{
		...
		{
			return this.name.equals(((SColor) other).getName())
					&& this.hue == ((SColor) other).getHue()
	...
	/**
	 * Method is unused. This is only here to appease checkstyle.
	 */
	@Override
	public int hashCode()
	{
